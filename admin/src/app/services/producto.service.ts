...
export class ProductoService {
  ...
  actualizar_prodcuto_admin(data: any, id: any, token: any): Observable<any> {
    if (data.portada) {
      let headers = new HttpHeaders({ Authorization: token });
      ...
      return this._http.put(`${this.url}actualizar_prodcuto_admin/${id}`, fd, {
        headers: headers,
      });
    } else {
      let headers = new HttpHeaders({
      ...
      return this._http.put(
        `${this.url}actualizar_prodcuto_admin/${id}`,
        data,
        {
          headers: headers,
        }
